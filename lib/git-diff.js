...
const { error, success, warn } = require('./logger');
const { checkWorkingDir } = require('./check-env');
const { generateUpdate } = require('./generate');
...
async function gitDiff (template, modules = [], verbose) {
  try {
